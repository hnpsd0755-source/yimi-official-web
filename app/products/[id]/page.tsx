          ...
          <div className="space-y-5">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {product.features.map((f: string) => (
                <div key={f} className="flex items-start gap-4 bg-white p-5 rounded-[24px] border border-slate-100 shadow-sm hover:border-blue-200 transition-all duration-300">
